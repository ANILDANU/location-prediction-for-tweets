...
plot_model(model, to_file='phase1_model.png', show_shapes=True, show_layer_names=True)

model.compile(loss = 'categorical_crossentropy', optimizer='adam',metrics = ['accuracy'])

print("Training .......................... ")

model.fit([x_word_train,x_char_train],[y1_train,y2_train], batch_size=32, epochs=10,verbose = 2)
